  ...
  return (
    <div>
      ...
      <div className=" w-screen  container mx-auto  ">
        <h1 className="text-2xl font-bold mb-4 text-center text-red-600">Rejected Requests</h1>
        {loading && <MySkeleton/>}
        {!loading && showNoItems && (
          ...
          <div className='m-auto'>
            ...
            <p className='text-xl text-zinc-500 pt-5 text-center'>You have no rejected requests</p>
          </div>
        )}
        {!loading && !showNoItems && (
...
export default RejectedUserRequests;
